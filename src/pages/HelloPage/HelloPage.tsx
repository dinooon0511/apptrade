...
export default function HelloPage() {
  ...
  return (
    <>
      <h1>
        Willkommen bei <span className={'primary-text'}>Geld</span>
      </h1>
      <hr />
      ...
      <div className={style.hero}>
        <HeroItem className={style.subHeader} icon={<Orb className={style.heroItemOrb}>1</Orb>}>
          <h3 className={style.heroItemHead}>
            Tippe, um mehr <span className={'primary-text'}>Münzen zu bekommen</span>
          </h3>
          <hr />
        ...
        <HeroItem
          ...
          <h3 className={style.heroItemHead}>
            Spiele mit <span className={'primary-text'}>Freunden</span>
          </h3>
          <hr />
          <span className={style.heroItemDescription}>
        ...
        <HeroItem className={style.subHeader} icon={<Orb className={style.heroItemOrb}>3</Orb>}>
          <h3 className={style.heroItemHead}>
            <span className={'primary-text'}>Vorteil</span>
          </h3>
          <hr />
          <span className={style.heroItemDescription}>
